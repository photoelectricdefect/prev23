...
public class SymbTable {
	...
	public void ins(String name, AstNameDecl decl) throws CannotInsNameException {
		...
		if (!allDeclsOfName.isEmpty()) {
			...
			if (declOfName.depth == currDepth)
				throw new CannotInsNameException(String.format("Name %s already declared at this scope, depth %d",name,currDepth));
		}
	...
	public AstNameDecl fnd(String name) throws CannotFndNameException {
		LinkedList<ScopedDecl> allDeclsOfName = allDeclsOfAllNames.get(name);
		if (allDeclsOfName == null)
			throw new CannotFndNameException(String.format("No declarations for name %s",name));
	...
	public class CannotInsNameException extends Exception {
		...
		private CannotInsNameException(String msg) {
			super(msg);
		}
	}
	...
	public class CannotFndNameException extends Exception {
		...
		private CannotFndNameException(String msg) {
			super(msg);
		}
	}
